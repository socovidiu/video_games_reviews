...
const GameReview = sequelize.define('GameReview', {
  ...
  rating: { type: DataTypes.FLOAT }, // Individual rating
});
...
Game.hasOne(GameDetails, { foreignKey: 'gameId', onDelete: 'CASCADE' });
GameDetails.belongsTo(Game, { foreignKey: 'gameId' });

Game.hasMany(GameImage, { foreignKey: 'gameId', onDelete: 'CASCADE' });
GameImage.belongsTo(Game, { foreignKey: 'gameId' });

Game.hasMany(GameReview, { foreignKey: 'gameId', onDelete: 'CASCADE' });
